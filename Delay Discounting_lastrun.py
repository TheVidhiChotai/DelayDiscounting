...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Riddhi\\Documents\\Lab in Psychology\\T6 Delay Discounting\\Delay Discounting_lastrun.py',
...
text_2 = visual.TextStim(win=win, name='text_2',
    ...
    color=[-0.2549, 0.2392, 0.2549], colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-2.0);
...
for thisTrial in trials:
    ...
    text.setText("USD " + str(reward_today) + " today" + " or " + " USD " + str(future_reward) + " after " + str(delay) + " days")
    ...
    trialComponents = [fixation, text, text_2, text_3, mouse]
